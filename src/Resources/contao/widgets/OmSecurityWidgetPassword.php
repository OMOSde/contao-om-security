 ...
 * @author    René Fehrmann <rene.fehrmann@omos.de>
 */
class OmSecurityWidgetPassword extends \Password
{
    ...
    protected function validator($varInput)
    {
        ...
        if (\Config::get('passwordList'))
        {
            $objPasswords = OmSecurityPasswordModel::findPublishedPasswordsByMultiplePids($varInput, deserialize(\Config::get('passwordList'), true));
            if ($objPasswords)
            {
                // add error
